    ...
    <div className="bg-[#121414] text-[#e2e2e2] min-h-screen w-full flex font-sans antialiased">
      <main className="w-full h-screen flex flex-col md:flex-row overflow-hidden">
        ...
        <section className="hidden md:flex md:w-1/2 relative bg-[#0c0f0f] items-center justify-center p-16 overflow-hidden border-r border-white/5">
          <div className="absolute w-[600px] h-[600px] bg-[#00d2ff] rounded-full blur-[120px] top-0 left-[-150px] opacity-15 z-0" />
          <div className="absolute w-[500px] h-[500px] bg-[#6e208c] rounded-full blur-[100px] bottom-[-100px] right-[-100px] opacity-20 z-0" />
        ...
        <section className="w-full md:w-1/2 h-full flex flex-col items-center justify-center p-6 md:p-16 relative bg-[#0c0f0f] md:bg-[#121414]">
          ...
          <div className="relative z-10 w-full max-w-[440px] bg-[#1a1c1c]/60 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 md:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <header className="mb-8">
              <h2 className="text-[32px] font-bold text-[#e2e2e2] mb-2">Sign In</h2>
              <p className="text-[#bbc9cf] text-sm">Enter your credentials to access your dashboard.</p>
            </header>

            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              {/* Email */}
              <div className="flex flex-col gap-2">
                <label className="text-[#bbc9cf] text-[11px] font-bold tracking-widest uppercase" htmlFor="email">Email</label>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center">
                  <label className="text-[#bbc9cf] text-[11px] font-bold tracking-widest uppercase" htmlFor="password">Password</label>
              ...
              >
                {loading ? (
                  ...
                  <>Sign In <span className="material-symbols-outlined group-hover:translate-x-1 transition-transform">arrow_forward</span></>                    
                )}
              </button>
            </form>
            ...
            <div className="flex items-center gap-4 my-8 w-full opacity-60">
              ...
              <span className="text-[#3c494e] text-[10px] font-bold tracking-widest uppercase">Or</span>
